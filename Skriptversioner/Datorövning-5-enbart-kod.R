...
##### Övningsuppgift 5.27 #####
Beräkna antalet hemmasegrar i herrallsvenskan genom att räkna antalet matcher där `Hemmamål` överstiger `Bortamål`.
:::
...
##### Övningsuppgift 5.29 #####
Använd `binom.asymp()` från paketet `binom` för att beräkna ett konfidensintervall för andelen hemmasegrar. Jämför med en handräkning (hand och miniräknare).
:::

##### Övningsuppgift 5.30 #####
Följande beräknar antalet hemmasegrar för Malmö FF. Testa om Malmös andel hemmasegrar är större än 47 procent.
