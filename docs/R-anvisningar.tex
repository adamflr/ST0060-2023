...
\hypertarget{valfria-hemuppgifter-3}{%
\section{Valfria hemuppgifter}\label{valfria-hemuppgifter-3}}

\begin{exercise}[Provstavar]
Mätningar av halten av något ämne i provstavar gav följande serie resultat.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{16}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{23}\NormalTok{, }\DecValTok{30}\NormalTok{, }\DecValTok{28}\NormalTok{, }\DecValTok{37}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{exercise}[Provstavar, forts.]
Kan man ur konfidensintervallet i föregående uppgift se om 28 är ett \emph{rimligt} värde på medelvärdet?
\end{exercise}

\begin{exercise}[Konfidensintervall och populationen]
...
\begin{exercise}[Konstant stickprov]
Om det inte finns någon spridning i ett stickprov är medelfelet noll och konfidensintervallet blir en enskild punkt (det skattade medelvärdet). Hur reagerar funktionen \texttt{t.test()} om man anger ett stickprov utan någon spridning - det vill säga där alla värden är samma värde?
\end{exercise}

\begin{exercise}[Känd standardavvikelse]
Det test som genomförs med \texttt{t.test()} är testet när standardavvikelsen skattas med \texttt{s} (fallet med okänd populationsstandardavvikelse). I fallet med känd populationsstandardavvikelse kan man istället göra ett z-test. Sök på internet efter ett R-paket som kan genomföra ett sådant z-test.
\end{exercise}
...
\hypertarget{valfria-hemuppgifter-4}{%
\section{Valfria hemuppgifter}\label{valfria-hemuppgifter-4}}
...
## $emmeans
##  group emmean    SE df lower.CL upper.CL
##  a     -0.217 0.337 45   -0.896    0.461
##  b     -0.395 0.337 45   -1.074    0.284
##  c     -0.293 0.337 45   -0.971    0.386
##  d     -0.154 0.337 45   -0.833    0.525
##  e      0.113 0.337 45   -0.566    0.792
## 
## Confidence level used: 0.95 
## 
## $contrasts
##  contrast estimate    SE df t.ratio p.value
##  a - b      0.1774 0.477 45   0.372  0.7114
##  a - c      0.0751 0.477 45   0.157  0.8756
##  a - d     -0.0633 0.477 45  -0.133  0.8950
##  a - e     -0.3305 0.477 45  -0.693  0.4916
##  b - c     -0.1024 0.477 45  -0.215  0.8309
##  b - d     -0.2407 0.477 45  -0.505  0.6160
##  b - e     -0.5080 0.477 45  -1.066  0.2922
##  c - d     -0.1383 0.477 45  -0.290  0.7730
##  c - e     -0.4056 0.477 45  -0.851  0.3993
##  d - e     -0.2672 0.477 45  -0.561  0.5778
\end{verbatim}
